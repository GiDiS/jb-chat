...
const (
	...
	ChannelsGetLastSeen events.Type = "channels.get-last-seen" // +
	ChannelsLastSeen    events.Type = "channels.last-seen"     // +
	ChannelsSetLastSeen events.Type = "channels.set-last-seen" // +
)
